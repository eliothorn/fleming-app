...
const KNOWN_PEOPLE = {
  ...
  // Lease fields mirror what the Buildium matcher sets on a real resident, so the
  // lease card renders in demo mode instead of showing dashes and a load error.
  "sarah@fleming.test": { role: "resident", name: "Sarah M.", unit: "Unit 4B", address: "214 Walnut St", leaseId: 4001, leaseEnd: "2027-06-30", leaseStatus: "Active", rent: 1450 },
  "tom@fleming.test": { role: "resident", name: "Tom B.", unit: "Unit 2A", address: "214 Walnut St", leaseId: 4002, leaseEnd: "2027-03-31", leaseStatus: "Active", rent: 1275 },
