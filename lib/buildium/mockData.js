...
export const MESSAGES = {
  ...
  resident: [
    { name: "Fleming Realty", last: "Your HVAC request assigned to Daflure HVAC.", time: "1h ago", unread: 1, color: "#1F2EAD", init: "F", type: "manager", role: "Property Manager" },
  ...
  owner: [
    ...
    { name: "Fleming Realty", last: "Monthly report for May is ready to review.", time: "Jun 1", unread: 0, color: "#065F46", init: "F", type: "manager", role: "Property Manager" },
  ...
  vendor: [
    { name: "Marcus J.", last: "Can you come today for the AC at Unit 4B?", time: "9:15am", unread: 1, color: "#1F2EAD", init: "M", type: "employee", role: "Employee · Fleming Realty" },
    { name: "Fleming Realty", last: "New work order assigned: Water leak, 330 Pine.", time: "5h ago", unread: 1, color: "#065F46", init: "F", type: "manager", role: "Property Manager" },
  ],
  applicant: [
    { name: "Fleming Realty", last: "Your application is under review.", time: "Jun 8", unread: 1, color: "#1F2EAD", init: "F", type: "manager", role: "Property Manager" },
  ],
};
