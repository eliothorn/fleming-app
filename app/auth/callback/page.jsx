    ...
    <div style={wrap}>
      {error ? (
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 15.5, fontWeight: 800, letterSpacing: "-.02em", marginBottom: 6 }}>Signing you in…</div>
...
const wrap = {
  ...
  padding: 24, fontFamily: "var(--font-jakarta), sans-serif",
};
const badge = {
  width: 52, height: 52, borderRadius: 15, margin: "0 auto 16px",
  background: "linear-gradient(135deg,#1F2EAD,#3B4FD8)",
  display: "flex", alignItems: "center", justifyContent: "center",
  boxShadow: "0 8px 24px rgba(31,46,173,.4)",
};
const btn = {
  background: "#1F2EAD", color: "#fff", border: "none", borderRadius: 10,
